    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-right" id="app-navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto ">
                ...
                <li><a class="btn btn-link text-white" href="{{ route('register') }}"><span>Register</span></a>
                </li>
                @else
                <li class="dropdown">
                ...
                <form class="form-inline" name="searchForm" id="searchForm">
                    <input class="form-control mx-sm-2 form-control-sm" name="q" value="{{request('q')}}" type="text" placeholder="Search">
